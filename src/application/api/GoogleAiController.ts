import { Controller, Get, Query, NotFoundException, InternalServerErrorException, Post, Body, Param } from '@nestjs/common';
...
export class GoogleAiController {
  ...
  @ApiGenerateText()
  public async generateGeminiPro(@Body('prompt') prompt: string): Promise<CoreApiResponse<JobDescriptionDTO>> {
