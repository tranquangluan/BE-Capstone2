...
export class MappingService {
    ...
    async compare(jobDescription: JobDescriptionDTO, resume: ResumeDTO, uid: string, jd: string): Promise<Resumes> {
      ...
      if (!resume) {
        ...
        +' Trường hợp 3: nếu hồ sơ năng lực không có thì trả về mảng rỗng nếu là mảng và null nếu là trường bình thường.'
        ...
        +' Ví dụ:'
        +' Trường hợp 1: Nếu không tìm thấy project nào thích hợp thì trả về {[{"company": "", "jobTitle": "","date": "","descriptions":"[] datatype là string[]",}]}.';
        ...
        +' Ví dụ:'
        +' Trường hợp 1: Nếu không tìm thấy project nào thích hợp thì trả về {"featuredSkills":"[]" ,descriptions:"[] datatype là string[]",}.'
        +' Trường hợp 2: nếu hồ sơ năng lực không có thì trả về mảng rỗng nếu là mảng và null nếu là trường bình thường.'
