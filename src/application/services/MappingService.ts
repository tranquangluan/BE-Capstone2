...
export class MappingService {
    ...
    async compare(jobDescription: JobDescriptionDTO, resume: ResumeDTO, uid: string, jd: string): Promise<Resumes> {
      ...
      if (!resume) {
        ...
        const promptEdu = 'Và trả ra kết quả là 1 mảng json theo cấu trúc hoàn toàn giống như sau và không dư thừa gì khác. Phải trả về đủ trường "school","degree","date","gpa","descriptions":'
        ...
        const promptExp = 'Và trả ra kết quả là 1 mảng theo cấu trúc hoàn toàn giống như sau và không dư thừa gì khác. Phải trả về đủ trường "company","jobTitle","date","descriptions":'
        ...
        const promptProj = 'Và trả ra kết quả là 1 mảng theo cấu trúc hoàn toàn giống như sau và không dư thừa gì khác. Phải trả về đủ trường "project","date","descriptions":'
